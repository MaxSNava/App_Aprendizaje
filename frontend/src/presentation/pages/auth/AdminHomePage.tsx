  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-semibold text-gray-800">Dashboard de Resultados</h2>
              <p className="text-sm md:text-base text-gray-600 mt-2">
      ...
      <div className="mt-8 bg-white p-4 md:p-6 rounded-lg shadow-md">
        <h2 className="text-xl md:text-2xl font-semibold text-gray-800 mb-4">Resumen de Actividad</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-blue-100 p-4 rounded-lg">
            <h3 className="text-base md:text-lg font-semibold text-blue-800">Usuarios Totales</h3>
            <p className="text-2xl md:text-3xl font-bold text-blue-600">1,234</p>
          </div>
          <div className="bg-green-100 p-4 rounded-lg">
            <h3 className="text-base md:text-lg font-semibold text-green-800">Tests Completados</h3>
            <p className="text-2xl md:text-3xl font-bold text-green-600">5,678</p>
          </div>
        </div>
      </div>
    </div>
